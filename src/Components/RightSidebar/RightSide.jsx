  ...
  return (
    <div className="flex flex-col h-screen bg-white shadow-lg border-2 rounded-l-xl">
      ...
      <p className="font-roboto font-normal text-sm text-gray-700 max-w-fit no-underline tracking-normal leading-tight py-2 mx-2">
        This site is under development as your throghts can shaere here like facebook 
        you can like comment or delete as you can share your experance your feelings or whatever everything as you want you can share with us
      </p>
