    ...
    <div className="flex flex-col h-screen bg-white pb-4 border-2 rounded-r-xl shadow-lg">
      ...
      <div className="ml-2">
        ...
        <div className="flex items-center">
          ...
          <p className="font-roboto font-bold text-lg text-black bg-clip-text bg-gradient-to-r to-white-700 from-blue-500 no-underline tracking-normal leading-none py-2">
            Social Network
          </p>
        </div>
        <div className="flex items-center">
